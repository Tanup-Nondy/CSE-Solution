  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="regForm" action="loginn.php" method="post">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            <h2 class="section-title mb-3">All Semester At One Place</h2>
          ...
          <table id="datatable" class="table table-hover table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{route('admin.divisions.edit',$division->id)}}" class="btn btn-success">View</a>
              ...
              <div class="px-4">
                <h3><a href="#" class="btn btn-dark">Add A New Session</a></h3>
                <div class="mb-3">
