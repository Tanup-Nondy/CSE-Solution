      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            <h2 class="section-title mb-3"><br>All Subjects At One Place</h2>
            <p>You can create and view subject here.</p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="card-body table-wrap">
          ...
          <table id="datatable" class="table table-hover table-striped">
            ...
            <?php
            include "db.php";
            $select="SELECT DISTINCT subject FROM subjects";
            ...
            ?>
              <tr>
                ...
                <td>
                  <form class="inline" action="view_books.php" method="post" accept-charset="utf-8">
                      <input type="hidden" name="subject" value="<?php echo $row['subject'];?>">
                      <button type="submit" class="btn btn-success">View</button>
                  </form>
                </td>
                <td>
                  <form action="delete_subject.php" method="post" accept-charset="utf-8">
                      <input type="hidden" name="subject" value="<?php echo $row['subject'];?>">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="regForm" action="add_subject.php" method="post">
