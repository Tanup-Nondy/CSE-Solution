      ...
      <div class="container">
        ...
        <div class="card-body table-wrap">
          ...
          <table id="datatable" class="table table-hover table-striped">
            ...
            <?php
            include "db.php";
            $select="SELECT DISTINCT session,semester FROM sem_ses";
            ...
            ?>
              <tr>
                ...
                <td>
                  <form class="inline" action="view_routine.php" method="post" accept-charset="utf-8">
                ...
                <td>
                  <form action="delete_routine.php" method="post" accept-charset="utf-8">
                      <input type="hidden" name="session" value="<?php echo $row['session'];?>">
                      <input type="hidden" name="semester" value="<?php echo $row['semester'];?>">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add New Routine</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="regForm" action="add_routine.php" method="post">
              <div class="form-group">
                <label for="session">Session </label>
                <input type="text" name="session" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                
              </div>
              
              <div class="form-group">
                <label for="semester">Semester </label>
                <input type="text" name="semester" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
